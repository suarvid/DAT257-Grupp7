            ...
            <div className="textPageContainer center">
                ...
                <div className= "cardContainer">
                    ...
                    <div className="companyInfo">
                        <p style={{padding:"0px 15px 5px 15px"}}>Yoga erbjuder många verktyg för att hitta in i dig själv och Yogamidus vill vara ditt stöd på vägen. Genom ergonomiska rörelser och positioner lär du känna din kropp och ditt sinne, för att sedan kunna gå vidare in i dig själv om du så vill.</p>
                    </div>
                </div>
                ...
                <div className= "cardContainer">
                    ...
                    <div className="companyInfo">
                        <p style={{padding:"0px 15px 5px 15px"}}>NiaMotion är ett företag som drivs av lust och glädje att dela med sig av rörelse och hälsa
                        (Nia, Yinyoga mm) framförallt i gemenskap med andra. NIA bidrar bl.a. till medvetenheten
                        om hur vi genom att använda helheten kropp- själ- tanke- ande i rörelse, kan påverka vårt
                        välbefinnande.</p>
                    </div>
                </div>
                ...
                <div className= "cardContainer">
                    ...
                    <div className="companyInfo">
                        <p style={{padding:"0px 15px 5px 15px"}}> Företaget UnikaRum har som mål att verka för att människor hittar och tar till vara sina unika
                        inre och yttre rum. Detta gör vi för att bidra till människors ökade välmående och hälsa.
                        Vi prövar på olika kreativa uttryck såsom måleri, skrivande, inre bildskapande, dans,
                        berättande, mm. för att utvecklas och växa som människor.
                        Namnet och företaget UnikaRum sammanfattar vårt förhållningssätt till människan, att vi alla
                        är unika och har våra individuella unika rum där vi kan finna de skatter vi har inom oss.</p>
                    </div>
                </div>
         </div>
    )
